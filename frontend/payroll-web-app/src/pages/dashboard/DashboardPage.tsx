...
export const DashboardPage: React.FC = () => {
  ...
  const quickActions = [
    { title: 'Add New Employee', icon: <PersonAdd />, path: '/employees/create' },
    { title: 'Calculate Payroll', icon: <Calculate />, path: '/payroll/calculation' },
    { title: 'Generate Reports', icon: <FileDownload />, path: '/reports' },
    { title: 'View Analytics', icon: <TrendingUp />, path: '/analytics' },
  ];
